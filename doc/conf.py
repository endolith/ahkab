# -*- coding: utf-8 -*-
#
# ahkab documentation build configuration file, created by
...
project = u'ahkab'
copyright = u'2014, Giuseppe Venturini'
...
latex_documents = [
  ('index', 'ahkab.tex', u'ahkab Documentation',
...
man_pages = [
    ('index', 'ahkab', u'ahkab Documentation',
...
texinfo_documents = [
  ('index', 'ahkab', u'ahkab Documentation',
   u'Giuseppe Venturini', 'ahkab', 'One line description of project.',
   'Miscellaneous'),
]
